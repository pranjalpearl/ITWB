(function (e, t) {
  ...
  function E(e, t, r, a, p) {
    ...
    var i = v(r, a, o, p),
      ...
      s = Object.keys(n)
        .map(function (e) {
          return Te({ key: e }, n[e], { area: k(n[e]) });
        })
        .sort(function (e, t) {
  ...
  function K(e, t, r, a) {
    ...
    if ("vh" === i || "vw" === i) {
      ...
      return (
        (l =
          "vh" === i
            ? ae(document.documentElement.clientHeight, window.innerHeight || 0)
            : ae(document.documentElement.clientWidth, window.innerWidth || 0)),
        (l / 100) * o
      );
    }
    return o;
  ...
  function Z() {
    document.addEventListener("click", Yt, !0),
      document.addEventListener("touchstart", Lt, { passive: !0 }),
      window.addEventListener("blur", St),
      window.addEventListener("resize", Pt),
      !ye &&
        (navigator.maxTouchPoints || navigator.msMaxTouchPoints) &&
        document.addEventListener("pointerdown", Lt);
  }
  function $(e, t) {
    function r() {
      yt(function () {
    ...
    function p(e) {
      ...
      if (q.popperInstance) {
        var p = xt(q.popper),
          ...
          s = i ? ae(o, r) : r,
          l = n ? ae(o, a) : a;
        i && s > o && (s = ee(r, window.innerWidth - o)),
          n && l > o && (l = ee(a, window.innerHeight - o));
    ...
    function o(e) {
      ...
      t &&
        !t._tippy &&
        ($(t, ie({}, q.props, { target: "", showOnInit: !0 })), i(e));
    }
    function i(e) {
    ...
    function m(e) {
      ...
      r ||
        a ||
        (ut(xt(q.popper), q.popper.getBoundingClientRect(), e, q.props) &&
          (l(), n()));
    }
    function c(e) {
      return y(e)
    ...
    function u() {
      var e = q.popperChildren.tooltip,
        ...
        p = e.querySelector(r),
        o = ie({ placement: q.props.placement }, t || {}, {
          ...
          onCreate: function () {
            (e.style[xt(q.popper)] = gt(q.props.distance, ne.distance)),
              p && q.props.arrowTransform && ft(p, q.props.arrowTransform);
          },
          onUpdate: function () {
            var t = e.style;
            (t.top = ""),
              ...
              (t.left = ""),
              (t.right = ""),
              (t[xt(q.popper)] = gt(q.props.distance, ne.distance)),
              p && q.props.arrowTransform && ft(p, q.props.arrowTransform);
          },
        });
    ...
    function w() {
      ...
      (function e() {
        q.popperInstance && q.popperInstance.scheduleUpdate(),
          q.state.isMounted ? requestAnimationFrame(e) : We([q.popper], 0);
      })();
    }
    function v(e, t) {
      E(e, function () {
    ...
    function A() {
      ...
      Et(e, ne);
      var t = q.props,
        r = wt(q.reference, ie({}, q.props, e, { performance: !0 }));
      (r.performance = Ot(e, "performance") ? e.performance : t.performance),
        (q.props = r),
        (Ot(e, "trigger") || Ot(e, "touchHold")) && (L(), C()),
        Ot(e, "interactiveDebounce") &&
          (l(), (_ = kt(m, e.interactiveDebounce))),
        Qe(q.popper, t, r),
        (q.popperChildren = Be(q.popper)),
        q.popperInstance &&
          le.some(function (t) {
            return Ot(e, t);
          }) &&
    ...
    function Y() {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ? arguments[0]
          : Ve(q.props.duration, 0, ne.duration[0]);
      return q.state.isDestroyed || !q.state.isEnabled || (Ct && !q.props.touch)
        ? void 0
    ...
    function S() {
      var e =
        0 < arguments.length && void 0 !== arguments[0]
          ? arguments[0]
          : Ve(q.props.duration, 1, ne.duration[1]);
      q.state.isDestroyed ||
        !q.state.isEnabled ||
        !1 === q.props.onHide(q) ||
        (0 === q.props.updateDuration &&
        ...
        q.props.interactive &&
          !z &&
          -1 < ["focus", "click"].indexOf(I.type) &&
          ("focus" === I.type && (z = !0), it(q.reference)),
        v(e, function () {
          W || s(),
    ...
    function P(e) {
      q.state.isDestroyed ||
        (q.state.isMounted && S(0),
        L(),
        q.reference.removeEventListener("click", r),
        delete q.reference._tippy,
        q.props.target &&
          e &&
          Ne(q.reference.querySelectorAll(q.props.target)).forEach(function (
            e
          ) {
    ...
    U.addEventListener("mouseenter", function (e) {
      ...
      U.addEventListener("mouseleave", function (e) {
        q.props.interactive &&
          ...
          ut(xt(U), U.getBoundingClientRect(), e, q.props) &&
          n();
      });
    var V = Be(U),
      q = {
    ...
    return (
      ...
      D.showOnInit && i(),
      !D.a11y || D.target || Re(e) || e.setAttribute("tabindex", "0"),
      (e._tippy = q),
      (U._tippy = q),
      q
    );
  ...
  for (
    var ee = Math.min,
      ...
      me = de ? navigator : {},
      ce = de ? window : {},
      fe = ("MutationObserver" in ce),
      he = /MSIE |Trident\//.test(me.userAgent),
      be = /iPhone|iPad|iPod/.test(me.platform) && !ce.MSStream,
      ye = ("ontouchstart" in ce),
      ue = "undefined" != typeof window && "undefined" != typeof document,
      ge = ["Edge", "Trident", "Firefox"],
      xe = 0,
      we = 0;
    we < ge.length;
    we += 1
      ...
      function t(r, a) {
        ...
        Oe(this, t),
          ...
          (this.modifiers = Object.keys(this.options.modifiers)
            .map(function (e) {
              return Te({ name: e }, p.options.modifiers[e]);
            })
            .sort(function (e, t) {
  ...
  (De.Utils = ("undefined" == typeof window ? global : window).PopperUtils),
    (De.placements = Ye),
    (De.Defaults = {
      placement: "bottom",
      positionFixed: !1,
        ...
        arrow: {
          ...
          fn: function (e, r) {
            ...
            return (
              (v = ae(ee(n[d] - y, v), 0)),
              (e.arrowElement = p),
              (e.offsets.arrow = ((a = {}), Le(a, c, re(v)), Le(a, f, ""), a)),
              e
            );
          },
          element: "[x-arrow]",
  ...
  var Xe = {
    ...
    _e = function (e, t) {
      e[Ie.x && "innerHTML"] =
        t instanceof Element ? t[Ie.x && "innerHTML"] : t;
    },
    Fe = function (e) {
    ...
    $e = function (e, t) {
      ...
      return (
        ...
        t.interactive && Ke(r, a),
        t.arrow && a.appendChild(qe(t.arrowType)),
        t.animateFill &&
          (a.appendChild(je()), a.setAttribute("data-animatefill", "")),
    ...
    Qe = function (e, t, r) {
      ...
      (e.style.zIndex = r.zIndex),
        ...
        t.content !== r.content && He(o, r),
        !t.animateFill && r.animateFill
          ? (p.appendChild(je()), p.setAttribute("data-animatefill", ""))
          : t.animateFill &&
            !r.animateFill &&
            (p.removeChild(i), p.removeAttribute("data-animatefill")),
        !t.arrow && r.arrow
          ? p.appendChild(qe(r.arrowType))
          : t.arrow && !r.arrow && p.removeChild(n),
        t.arrow &&
          r.arrow &&
          t.arrowType !== r.arrowType &&
          p.replaceChild(qe(r.arrowType), n),
        !t.interactive && r.interactive
          ? Ke(e, p)
          : t.interactive && !r.interactive && Ge(e, p),
        !t.inertia && r.inertia ? Je(p) : t.inertia && !r.inertia && Ze(p),
        t.theme !== r.theme &&
          (t.theme.split(" ").forEach(function (e) {
    ...
    ft = function (e, t) {
      var r = xt(pt(e, Xe.POPPER)),
        ...
        p = "right" === r || "bottom" === r,
        o = {
          translate: { axis: dt(t, "translate"), numbers: mt(t, ct.translate) },
          scale: { axis: dt(t, "scale"), numbers: mt(t, ct.scale) },
        },
        i = t
          .replace(
            ct.translate,
            "translate" +
              st(o.translate.axis, a) +
              "(" +
              lt("translate", o.translate.numbers, a, p) +
              ")"
          )
          .replace(
            ct.scale,
    ...
    Lt = function () {
      Ct ||
        ((Ct = !0),
        be && document.body.classList.add("tippy-iOS"),
    ...
    At = function e() {
      ...
      20 > t - Tt &&
        ...
        !be && document.body.classList.remove("tippy-iOS")),
        (Tt = t);
    },
    Yt = function (e) {
      var t = e.target;
  ...
  (Q.version = oe),
    ...
    (Q.disableAnimations = function () {
      Q.setDefaults({ duration: 0, updateDuration: 0, animateFill: !1 });
    }),
    (Q.hideAllPoppers = et),
    (Q.useCapture = function () {});
  return (
    de &&
      setTimeout(function () {
